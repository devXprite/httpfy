...
program
    ...
    .option("-c, --cookie <string>", "send cookies (--cookie 'login=Yes')")
    .option("-x, --request-methods <string>", "set request methods, use 'all' to probe all HTTP methods")
    .option("-H, --header <string>", "custom http headers to send (--header 'X-MyHeader: XYZ')")
    .option("-pc, --protocol <string>", "set request Protocol", "https")
    .option("-path, --request-path <string>", "path or list of paths  (-path admin,login)")
    .option("-param, --request-param <string>", "set request parameters  (-param id=5)")
...
program
    ...
    .option("-ms, --match-string <string> ", "match response with specified strings  (-ms admin)");

program
    .option("-o , --output-file <string>", "save results in a single file  (-o result.txt)")
    .option("-of, --output-folder <string>", "save results in multiple files accoring status code  (-of result)");
