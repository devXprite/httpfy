...
const httpfyConfig = {
    ...
    RedirectLocation:
        args.redirectLocation !== null && args.redirectLocation !== undefined ? args.redirectLocation : false,
    ...
    maxRedirect: (args.redirect !== null && args.redirect !== undefined ? args.redirect : false)
        ? Number(args.maxRedirect || 5)
        : 0,
    ...
    MatchLineCount: args.matchLineCount
        ? new RegExp(
            args.matchLineCount
                .split(",")
                .map((e) => `^${e}$`)
    ...
    FilterCode: args.filterCode
        ...
        : false,
    FilterLineCount: args.filterLineCount
        ? new RegExp(
            args.filterLineCount
                .split(",")
                .map((e) => `^${e}$`)
                .join("|"),
        )
